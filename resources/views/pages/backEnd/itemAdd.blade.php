...
<div class="row">
  <div class="col-sm-12">
    <form action="{{ route('item.store')}}" method="POST" enctype="multipart/form-data" accept="image/*">
    {{csrf_field()}}
      <div class="row">
        <div class="col-lg-6">
          <div class="card-box">
          ...
          <div class="card-box">
            ...
            <div class="table-box m-b-30">
              <p style="text-align:center;">
                <img src="{{asset('images/default-item.png')}}" alt="Image" id="default-item" style="width: 250px; height: 250px;" />
              </p>
              </div>
